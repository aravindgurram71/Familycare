...
public class RegisterUser {
	static int status=0;
	//int accountno=0;
public static int register(String username,String password,String repassword,String disname,String address,String cityname,String statename,String country,String region,double phone,String email)
{
