...
<%@ page import="company.*" %>
    ...
    <td valign="top">
        ...
        <h1>Tablets</h1>
      <p>This high quality pharmaceutical company here all types of general medicens are manufactured.</p>
        <p align="right"><a href="#" class="more">View More</a></p>
    </td>
...
<div id="footer">
  <div id="footer_1">
    ...
    <span id="design">Designed by <a id="dum" href="https://www.linkedin.com/in/aravind-187473219" target="_blank">Aravind & prashanth</a></span>
    <script type="text/javascript">
