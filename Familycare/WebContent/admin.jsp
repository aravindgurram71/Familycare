...
<title>Family Care Pharmaceutical Company Template- Download HTML Website Templates</title>
...
<td valign="top">
    ...
    <td valign="top">
        ...
        <h1>Tablets</h1>
      <p>This high quality free pharmaceutical company here all type of general medicines are manufactured.</p>
        <p align="right"><a href="#" class="more">View More</a></p>
    </td>
...
<table width="960" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr align="justify">
    ...
    <td width="760" valign="top">
        ...
        <p>This is Family Care Pharmaceutical Company Template for your online website, blog or web page which is under Health and Medicine category. Anyone wants good, professional, template for their pharmacy, drug store, medical store then this template would be the best one. This free pharmaceutical company template is designed by professional designers to make your task much easier to customize it.</p><br />
