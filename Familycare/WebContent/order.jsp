...
<title>Family Care Pharmaceutical Company </title>
...
<table width="960" border="0" cellspacing="10" cellpadding="0" align="center">
  <tr align="justify">
	...
	<TD> Product Code : </TD> <TD> <SELECT NAME="ProdCode"> 
									<option value=a1> FLG0001
									<option value=a2> FLG0002
									<option value=a3> FLG0003
									<option value=a4> FLG0004
									<option value=a5> FLG0005
									<option value=a6> FLG0006
									<option value=a7> FLG0007
									<option value=a8> FLG0008
...
<TR><TD>  ModeofPayment: </TD> 
    ...
    <td valign="top">
        ...
        <h1>Tablets</h1>
      <p>This high quality free pharmaceutical company here all types of general medicenes are manufactured.</p>
        <p align="right"><a href="#" class="more">View More</a></p>
    </td>
...
<table width="960" border="0" cellspacing="0" cellpadding="0">
  <tr align="justify">
    ...
    <td width="760" valign="top">
    	<h1>Welcome to Family Care Pharmaceutical Company Template</h1>
        <p>This is Family Care Pharmaceutical Company Template for your online website, blog or web page which is 
		under Health and Medicine category. Anyone wants good, professional, template for their pharmacy, drug store, 
		medical store then this template would be the best one. This free pharmaceutical company template is designed 
		by professional designers to make your task much easier to customize it.</p><br />

	<p>There are many other template categories like Arts, Agriculture, Computers, Satellite, Cars, Finance, Nature, Music,
	Personal Website, Religious, Fashion, Furniture, Holiday, Travel, Night club are available in this site. Have a look at
	the collection of HTML templates, pick the right one, preview and download it easily.</p>
    </td>
  </tr>
</table>
</div>
...
<div id="footer">
  <div id="footer_1">
    ...
    <span id="design">Designed by <a id="dum" href="https://www.linkedin.com/in/aravind-187473219" target="_blank">Aravind&praveen</a></span>
    <script type="text/javascript">
...
<div id="footer_top">
  ...
  <div id="footer_copyright" >
    	    ...
    	    <center><img  alt="Serviced"  width="196" height="106"></center><br>
		    <p>Each people plan their site layouts depending upon their business type. Here comes a free designer template
			which provides you with a selection of different kinds of webdesign   starting from business template, fashion 
			template, media template, Science template, Arts template and much more.</p>
	  
  Copyright © Av soft solutions</div>
</div>
