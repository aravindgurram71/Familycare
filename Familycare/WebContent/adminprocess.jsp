...
<%@ page import="company.*" %>
    ...
    <td valign="top">
        ...
        <h1>Tablets</h1>
      <p>This high quality pharmaceutical company here all types of gneric medicenes are manufactured.</p>
        <p align="right"><a href="#" class="more">View More</a></p>
    </td>
...
<table width="960" border="0" cellspacing="0" cellpadding="0">
  <tr align="justify">
    ...
    <td width="760" valign="top">
    	<h1>Welcome Family Care Pharmaceutical Company Template</h1>
